        ...
        <div className="max-w-4xl mx-auto space-y-16">
          <section className="text-center">
            <h1 className="text-3xl sm:text-4xl font-serif font-medium text-primary mb-4">
              {lang === "ID" ? "Tentang Gadang Barubah" : "About Gadang Barubah"}
            </h1>
            <div className="w-24 h-px bg-primary mx-auto mb-6" />
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              {lang === "ID"
                ? "Rumah makan Padang yang menghadirkan nasi padang autentik dan warisan kuliner Minang dengan standar kualitas tertinggi di Indonesia."
                : "A Padang restaurant that serves authentic Minang dishes and culinary heritage with the highest quality standards in Indonesia."}
            </p>
          </section>
          ...
          <section id="outlet">
            <div className="text-center mb-8">
              ...
              <p className="text-muted-foreground max-w-xl mx-auto">
                {lang === "ID"
                  ? "Kunjungi 2 cabang kami di Cikarang dan Bintaro"
                  : "Visit our 2 branches in Cikarang and Bintaro"}
              </p>
            </div>
